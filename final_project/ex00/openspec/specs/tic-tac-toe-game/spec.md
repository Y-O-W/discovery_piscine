...
## Purpose
Defines the core game rules and session flow for a two-player terminal tic-tac-toe game: player setup, board state, turn-based moves, win/draw detection, mid-round stop, round-boundary flow, and cross-round tallies.
